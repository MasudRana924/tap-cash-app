    ...
    >
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.chargeCard}>
          <Text style={styles.chargeLabel}>Cash Out Charge</Text>
          <Text style={styles.chargeAmount}>{cashOutCharge}</Text>
        </View>
...
export default CashOutAmountScreen;
